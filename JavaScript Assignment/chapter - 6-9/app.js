...
document.write("<b>Subjects    Total marks    Marks Obtained    Percentage</b>");
document.write("<br>");
document.write(subject1 +" "+" "+ total_numbers + marks_obtained_subject1 +" "+ marks_obtained_subject1/total_numbers*100+" %");
document.write("<br>");
document.write(subject2 +" "+" "+ total_numbers + marks_obtained_subject2 +" "+ marks_obtained_subject2/total_numbers*100+" %");
document.write("<br>");
document.write(subject3 +" "+" "+ total_numbers + marks_obtained_subject3 +" "+ marks_obtained_subject3/total_numbers*100+" %");
document.write("<br>");
document.write("Final Result " + total_numbers*3 + (marks_obtained_subject1+marks_obtained_subject2+marks_obtained_subject3)+(marks_obtained_subject1+marks_obtained_subject2+marks_obtained_subject3)/(total_numbers*3)*100);
